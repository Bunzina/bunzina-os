...
-- AWAITING_PAYMENT é o único status novo da Fase 4, entre AWAITING_APPROVAL e
-- IN_EXECUTION. Ver docs/contracts/events-saga-contracts.md no repositório bunzina.
DO $$ BEGIN
